...
public class AdapterLastRead extends RecyclerView.Adapter<AdapterLastRead.myHolder> {

    ArrayList<ModelDataLastRead> listLastRead = new ArrayList<>();
    SharedPreferences sharedPreferences;
    Context context;

    public AdapterLastRead(ArrayList<ModelDataLastRead> listLastRead, Context context) {
    ...
    public myHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lastread_card, viewGroup, false);
