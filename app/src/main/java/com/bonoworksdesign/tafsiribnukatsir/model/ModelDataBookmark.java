...
public class ModelDataBookmark {
    ...
    public ModelDataBookmark(String noSurat, int hal, String nmSurat, String jilid, String periode, String suratImg, int firstPage) {
